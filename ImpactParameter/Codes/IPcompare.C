...
void IPcompare()
{
  ...
  TFile* ff = new TFile("/home/jcrosby/WorkPlace/Histograms/Root_Files/DT_rebinned_mcp_d.root");
  TFile* ff_mc = new TFile("/home/jcrosby/WorkPlace/Histograms/Root_Files/DT_rebinned_mcp_d.root");
  ...
  for(int ips = 0; ips<ip; ++ips){
    ...
    for(int com=0; com<comp; ++com){
      ...
      TLegend* l1 = new TLegend(0.7,0.6,0.82,0.9);
      l1->SetBorderSize(0);
      l1->SetFillStyle(0);
      l1->SetTextFont(42);
      l1->SetMargin(0.4);
	...
	minuit->GetParameter(ipar,par[ipar],err[ipar]);
      ...
      TLegend* l2 = new TLegend(0.7,0.6,0.82,0.9);
      l2->SetBorderSize(0);
      l2->SetFillStyle(0);
      l2->SetTextFont(42);
      l2->SetMargin(0.4);
